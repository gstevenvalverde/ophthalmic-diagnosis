...
from .eye_examination import EyeExamination
...
class Diagnosis:
    ...
    def __str__(self):
        return f"Diagnosis: (diagnosis_id: {self.diagnosis_id}, diagnosis: {self.diagnosis}, \n-patient: {self.patient}, \n-eye_examination_od: {self.eye_examination_od}, \n--eye_examination_os: {self.eye_examination_os})"
