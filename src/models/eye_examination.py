from .eye_image import EyeImage
...
class EyeExamination:
    ...
    def __str__(self):
        return f"EyeExamination: (dioptre_1: {self.dioptre_1}, dioptre_2: {self.dioptre_2}, astigmatism: {self.astigmatism}, phakic_pseudophakic: {self.phakic_pseudophakic}, pneumatic: {self.pneumatic}, perkins: {self.perkins}, pachymetry: {self.pachymetry}, axial_length: {self.axial_length}, vf_md: {self.vf_md}, \n--eye_image: {self.eye_image})"
